...
//! machinery, the sum simply stops. `service_arb fit` runs the Adam loop offline and writes [`COEF`]
...
/// `service_arb fit examples/*.nix`, pooled over both Clermont studies: 200 orderings, of which the
