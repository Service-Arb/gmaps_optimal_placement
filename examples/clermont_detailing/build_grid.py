...
# bulk downloads and generated maps stay out of git
WORK = Path(os.environ.get("GEO_WORK", Path(__file__).parents[2] / "tmp" / "geo"))
ZIP = WORK / "data" / "filosofi2021_200m_csv.zip"
MEMBER = "carreaux_200m_met.csv"
OUT = WORK / "out" / "grid.geojson"
